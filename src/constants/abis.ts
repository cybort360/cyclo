/**
 * ABIs copied verbatim from Foundry build artifacts in /out.
 * Regenerate by running `forge build` and re-copying from
 * out/SubscriptionManager.sol/SubscriptionManager.json#abi.
 */
export const SUBSCRIPTION_MANAGER_ABI = [
  ...
  { type: "function", name: "checkPreFlight", inputs: [{ name: "planId", type: "uint256", internalType: "uint256" }, { name: "subscriber", type: "address", internalType: "address" }], outputs: [{ name: "readyToCharge", type: "bool", internalType: "bool" }, { name: "reasonCode", type: "uint8", internalType: "uint8" }], stateMutability: "view" },
  { type: "function", name: "subscribe", inputs: [{ name: "planId", type: "uint256", internalType: "uint256" }], outputs: [], stateMutability: "nonpayable" },
  { type: "event", name: "FeeCollected", inputs: [{ name: "planId", type: "uint256", indexed: true, internalType: "uint256" }, { name: "subscriber", type: "address", indexed: true, internalType: "address" }, { name: "fee", type: "uint256", indexed: false, internalType: "uint256" }], anonymous: false },
...
/** Minimal ERC-20 surface used for USDC interactions in scripts and the demo. */
